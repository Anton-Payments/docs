...
A **beneficiary** is who you're paying — a person or business. Personal details (name, address, DOB) are tokenized in a secure vault on creation; Anton's database never holds them in plaintext.
...
A **beneficiary** is the identity; an **instrument** is where the money goes — a bank account, wallet, or card. One beneficiary can have many instruments. Credentials (account numbers, wallet addresses, card PANs) are tokenized in a secure vault on receipt.
