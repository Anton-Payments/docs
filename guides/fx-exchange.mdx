...
In sandbox, rates come from a public reference-rate feed. Rate-limited to 30 per minute per IP. The rate is not locked — by the time you execute, it may have moved.
