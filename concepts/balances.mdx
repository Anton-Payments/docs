...
If you have a USD balance but need to send GBP, Anton can convert automatically. Request an [FX quote](/api-reference/fx/create-fx-quote) first to see the exchange rate, then [execute the exchange](/api-reference/fx/execute-fx-exchange) or create the payout with the quoted rate.
