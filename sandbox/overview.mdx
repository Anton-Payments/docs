...
- **Authentication** — same `Authorization: DPoP <access_token>` + `DPoP: <proof>` header pair, same `401` responses, same rotation flow. Sandbox access tokens live 8 hours rather than 1.
