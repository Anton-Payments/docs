...
<CardGroup cols={2}>
  ...
  <Card title="AI compliance screening" icon="shield-halved">
    Use Anton Intelligence standalone — payee, instrument, and onboarding risk evaluations with auditable evidence — on an account tier with no payout surface at all.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Authentication" icon="key" href="/authentication">
    OAuth + DPoP credentials, scopes, and secure usage.
  </Card>
...
- **Integration support** — [help.antonpayments.com](https://help.antonpayments.com). Include the `X-Request-ID` response header from any failing request; Anton retains a full server-side trace keyed by that ID.
- **Platform status** — [status.antonpayments.com](https://status.antonpayments.com).
- **Security reports** — email [security@antonpayments.com](mailto:security@antonpayments.com). Do not open public issues for suspected vulnerabilities. Initial acknowledgement within 24 hours, triage within 72.
