...
<Steps>
  <Step title="Register a beneficiary">
    Store who you're paying — their bank account, mobile wallet, or crypto address. Beneficiary details are tokenized and isolated per merchant. Create once, pay repeatedly.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Payouts" icon="money-bill-transfer" href="/concepts/payouts">
    The core object — a money movement from your balance to a beneficiary across any supported rail and corridor.
  </Card>
  <Card title="Beneficiaries" icon="users" href="/concepts/beneficiaries">
